        ...
        <div className="max-w-lg p-8 rounded-lg shadow-sm border border-blue-100 relative">
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h4 className="text-sm font-medium text-gray-800">Parameter Lab GenLab</h4>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">Click any node (hold Shift to select multiple nodes).</p>
                <p className="text-xs text-gray-600">Set parameter ranges and start batch generation.</p>
              </div>
            </div>
            
            <div className="mt-6 text-center">
              <p className="text-xs text-gray-600 mb-3">Let’s select a node to begin!</p>
            </div>
          </div>
        </div>
